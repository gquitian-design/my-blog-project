        ...
        <div className="w-full max-w-md bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
          ...
          <div className="text-center mb-8">
            <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white">
              Welcome{" "}
              <span className="text-blue-600 dark:text-blue-400">Back</span>
            </h2>
          ...
          <form className="flex flex-col gap-4" onSubmit={onSubmit}>
            ...
            <button
              type="submit"
              className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-md transition-all mt-2"
            >
              Submit
            </button>
          </form>
